...
В проекте использованы основные техники, использующиеся при работе с HTML и CSS, анимации, сторонний код *(normalize.css) (italic)*.
Код и структура файлов в проекте организованы согласно положениям БЭМ.

## Планы по доработке
- 1. Подключение дополнительных шрифтов в *page.css (italic)*;
